...
function HostileDialogue()
	...
	greetings[1] = {
		action="attack",
		player="",
		alien={"Your ship looks like it will bring a few credits.","Let's negotiate.  Drop shields, disarm weapons, close your eyes and count to 50..err..100.","01111 001 1011 111, 00111 1010 111 10 1 010 111 0100, 00011 0010 111 1010 001 000, 00001 0100 111 1010 01 1 0 100, 00000, 10000","From hunter to hunted, prepare to die.","Nice ship!  I'll take it!"} }
