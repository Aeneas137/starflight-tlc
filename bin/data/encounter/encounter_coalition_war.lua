--[[
	ENCOUNTER SCRIPT FILE: COALITION  WAR
...
function ObsequiousDialogue()
	...
	questions[60001] = {
		...
		choices = {
			...
			{ text="How are you obtaining Minex technology?", goto=63000 },
			{ text="How will you be taking over this sector?", goto=64000 },
	...
	questions[63000] = {
		action="jump", goto=60001,
		player="",
		alien={"Battlefield salvage is everywhere.  Minex ships do get destroyed occasionally seeing that they up and decided to attack every single other race in the sector.  The mad ones are particularly good at leaving unsalvaged hulks everywhere." }
	}
	questions[64000] = {
		action="jump", goto=64001,
		player="",
		alien={"Future?  Ehh, we HAD long-term plans.  The simpleminded Tafel are expanding faster than any thought possible.  We have been piecing them out more and more of our technology as they expand their territory, and prepare ourselves to be their allies when they finally clash with the foolish Bar-zhon aristocrats." }
	}
	questions[64001] = {
		action="jump", goto=60001,
		player="<More>",
	...
	questions[11110] = {
		action="jump", goto=11101,
		player="",
		alien={"The Bar-zhon government is getting what they deserve.  This infection has decimated their control.  More rats than ever before are leaving a sinking ship, mostly to our side." }
	}
	questions[11120] = {
		action="jump", goto=11101,
		player="",
	...
	questions[14101] = {
		...
		choices = {
			...
			{ text="How can we stop the Minex?",  goto=14120 },
			{ text="Do you know why they are attacking?",  goto=14130 },
			{ text="<Back>", goto=11001 }
		}
	}
	questions[14110] = {
	...
	questions[14130] = {
		action="jump", goto=14101,
		player="",
		alien={"Nope, but those guys are paranoid.  Maybe with all their advanced tech they just decided they could wipe us out with their biologics and their warships." }
	}
	...
	questions[24000] = {
		...
		alien={"The Minex are too much evil.  They never communicated with anyone and their technology is off the charts.  Until now they just left everyone alone, but now it looks like it's a matter of either our survival or theirs." }
	}
	questions[24100] = {
