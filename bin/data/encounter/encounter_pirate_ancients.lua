...
function HostileDialogue()
	...
	greetings[1] = {
		action="attack",
		player="",
		alien={"Inexemay!  Inexemay!  Inexemay!","Twas brillig, and the slithy toves, Did gyre and gimble in the wabe, All mimsy were the borogoves, And the mome raths outgrabe.","01111 001 1011 111, 00111 1010 111 10 1 010 111 0100, 00011 0010 111 1010 001 000, 00001 0100 111 1010 01 1 0 100, 00000, 10000"} }
