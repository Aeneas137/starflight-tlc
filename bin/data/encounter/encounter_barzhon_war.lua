--[[
	ENCOUNTER SCRIPT FILE: BARZHON  WAR
...
function ObsequiousDialogue()
	...
	questions[10000] = {
		...
		alien={"The Bar-zhon people and our Navy are the defenders of freedom in this region.  Many other races inhabit this area of space but none but the Minex come close to our strength and power.  If you want more specific about the Minex agression I may be able to answer some general inquiries on that subject."}
	}
	questions[20000] = {
	...
	questions[30000] = {
		...
		alien={"A few centicycles ago this entire region of space was enveloped by sector wide warfare known to historians as The Great War.   I have more recent and general information about the Minex agression if you wish."}
	}
	questions[40000] = {
		action="jump", goto=1,
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ text="How goes the war against the Minex?", goto=61000 },
			{ text="What news have about the the viral infection?", goto=62000 },
			{ text="How are the Coalition being more aggressive?", goto=63000 },
	...
	questions[61000] = {
		...
		player="",
		alien={"Minex millitary strength is more vast then we have dreamed.  They are maintaining a successful campaign against everyone at least so far.  Fortunately their tactics are flawed and their will for conquest is lacking. " }
	}
	questions[62000] = {
	...
	questions[61001] = {
		action="branch",
		choices = {
			{ text="How are their tactics flawed?", goto=61100 },
			{ text="You mentioned that the Minex are attacking all races?", goto=61200 },
			{ text="How has the war progressed so far?", goto=61300 },
			{ text="Do you know how to stop the Minex?", goto=61400 },
	...
	questions[61200] = {
		action="jump", goto=61202,
		player="",
		alien={"This is true as far as we know. This misstep we are fully taking advantage of.  Non-aggression pacts have been drawn up with the Thrynn, Elowan, and Tafel to share intelligence and to coordinate attacks against Minex, pirates, and rogue ships." }
	}
	questions[61202] = {
	...
	questions[61301] = {
		action="jump", goto=61001,
		player="So they just try to attack at weak points in your defense?",
		alien={"Essentially true but they are not actively using scouts and their tactics have caused them to bear the brunt of attacks from virus crazed ships of all races.  Their efforts have also weakened quite a few pirate organizations in your area of space.  Their attacks appeared to be blind and unfocused and despite their great technological power this demonstrates their lack of military leadership." }
	}
	questions[61400] = {
		action="jump", goto=61001,
		player="",
		alien={"We expect that Minex fleet losses will exceed the capacity of their industrial base.  When this becomes apparent we plan to counter attack against their worlds.  Attempted incursions during the great war led many to believe that the Minex homeworld to be located somewhere within the Pearl cluster." }
	}
	...
	questions[61210] = {
		action="jump", goto=61001,
		player="",
		alien={"Although Myrrdan's military strength is insignificant, please convey to your leaders the Bar-zhon people's desire to expand this unofficial alliance." }
	}
	questions[61220] = {
		action="jump", goto=61001,
		player="",
	...
	questions[62001] = {
		action="branch",
		choices = {
			{ text="What research were these teams conducting?", goto=62100 },
	...
	questions[62101] = {
		action="jump", goto=62001,
		player="Where is the Transmodra home world?",
	...
	questions[62200] = {
		...
		player="",
		alien={"Unfortunately not.  We have started to permanently lose contact with certain ships in our fleet and have heard similar reports from the other races as well.  At first the losses were attributed to warfare but tachyon identifier broadcasts continue." }
	}
	questions[62201] = {
		action="jump", goto=62001,
		player="What are these ships doing?",
		alien={"Wandering aimlessly and aggressively attacking any ship in range." }
	}
