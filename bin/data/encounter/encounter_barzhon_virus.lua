--[[
	ENCOUNTER SCRIPT FILE: BARZHON  VIRUS
...
function ObsequiousDialogue()
	...
	questions[10000] = {
		...
		alien={"The Bar-zhon people and our Navy are matched by none other.  Many other races inhabit this area of space but none come close to our strength and power.   If you want more specific about the viral infection I may answer some general inquiries on that subject."}
	}
	questions[20000] = {
		action="jump", goto=21001,
		player="What can you tell us about the other races in the galaxy?",
		alien={"Please be more specific.  Are you interested in the rabble known as the coalition?  Or the other races, the Tafel, the Nyssian, the Minex, the Thrynn and Elowan, the Spemin? or other pirates?  None of our intelligence of these races includes viral activity yet."}
	}
	questions[30000] = {
		action="jump", goto=31001,
		player="What can you tell us about the past?",
		alien={"A few centicycles ago this entire region of space was enveloped by sector wide warfare known to historians as The Great War.   I have more recent and general information about this virus infection if you wish."}
	}
	questions[40000] = {
		action="jump", goto=1,
	...
	questions[60001] = {
		action="branch",
		choices = {
			{ text="Do you know who is infected by the virus?", goto=61000 },
			{ text="Selected crews to madess?", goto=62000 },
			{ text="Any progress towards a cure?", goto=63000 },
			{ text="Are any other races taking advantage of this unrest?", goto=64000 },
	...
	questions[63001] = {
		...
		player="Anything your scientists can tell us about the virus?",
		alien={"The technology of this infectious nano virus is far beyond the capabilities of any existing race in this area of space. The Bar-Zhon military has been mobilized in search of archaeological digs which may have uncovered this nightmarish technology." }
	}
	questions[63002] = {
		action="jump", goto=60001,
		player="Archaeological digs?",
		alien={"The three imperialists were aided by some technology far beyond their science.  We have started to investigate many locations in their space.  For example many Bx fleets were found to be patroling an area far outside their region of space, often near the central supports of the tower." }
	}
	questions[64000] = {
		action="jump", goto=60001,
		player="",
		alien={"Not that we can detect.  The infection has even calmed incursions of the coalition for the moment.  Multiple alien fleet movements have been detected in the downspin and outward direction.  The significance of this is unknown at this time." }
	}
	questions[62001] = {
		action="branch",
		choices = {
			{ text="Do you eventually reestablish contact with rogue ships?", goto=62100 },
			{ text="Do these rogue ships do anything or try to go anywhere?", goto=62200 },
			{ text="Do rogue ships always return to sanity?", goto=62300 }, 
	...
	questions[62100] = {
		action="jump", goto=62001,
		player="",
		alien={"Sometimes.  Very few become derelicts losing all officers on board, most retain control of themselves after a time with no memory of the period of insanity.  Approaching these rogue ships instigates a firefight." }
	}
	questions[62200] = {
		action="jump", goto=62001,
		player="",
		alien={"Sickness and insanity have no rationality.  It is curious how the crew of an entire ship will go mad and also recover at the exact moments.  Is also curious how those in a period of insanity are so effective at operating their ships navigation and weaponry." }
	}
	questions[62300] = {
		action="jump", goto=62001,
		player="",
