...
elseif (plot_stage == 2) then  -- virus plot state
	...
	questions[63002] = {
		...
		alien={"The three imperialists were aided by some technology far beyond their science.  We have started to investigate many locations in their space.  For example many Bx fleets were found to be patrolling an area far outside their region of space, often near the central supports of the tower." }
	}
	questions[64000] = {
		action="jump", goto=60001, ftest= 2, -- insightful
...
--		ship_shield_class = ship_shield_class + 1,
		...
		alien={"For your efforts I have been authorized to enhance the defensive shielding of your vessel. " }
	}
	questions[74006] = {
--		artifact20 = 0,
--		active_quest = active_quest + 1,
--		ship_shield_class = ship_shield_class + 1,
		action="jump", goto=1, ftest= 1,
		player="Transferring the unit now.",
		alien={"We are unable to improve the efficiency of your shields, but we are willing to provide you a monetary award of energy crystals." }
	}
...
--		ship_missile_class = 6 or endurium += 35
	...
	questions[79105] = {
		action="jump", goto=1, ftest= 1,
		player="Transferring the unit now.",
		alien={"For your efforts I have been authorized to provide you with the top missile technology of our empire. " }
	}
	questions[74106] = {
		action="jump", goto=1, ftest= 1,
		player="Transferring the unit now.",
		alien={"We are unable to improve the missile technology of your vessel, but we are willing to provide you a monetary award of energy crystals." }
	}
	questions[79200] = {
...
--		active_quest = active_quest + 1
		...
		alien={"The Bar-zhon people appreciate your efforts and your friendliness.  In return I am authorized to offer you technical data that will improve the efficiency of your ship's engines.  We hope that future relationships between our people may progress in like manner." }
	}
...
--]]
	...
	questions[89000] = {
		...
		playerFragment="to decode this data on exotic particles",
...
--		active_quest = active_quest + 1,
		action="jump", goto=1, ftest= 1,
		player="[AUTO_REPEAT]",
		alien={"You have done well to submit to our authority." }
	}
...
--		ship_shield_class = ship_shield_class + 1,
	...
	questions[95000] = {
		action="jump", goto=1, ftest= 1,
		player="I've managed to obtain a coalition afterburner.",
		alien={"You have proven yourself to be resourceful.  " }
	}
...
--		ship_shield_class = ship_shield_class + 1,
		...
		alien={"Due to your efforts I will provide you enhancements for the defensive shielding of your vessel. " }
	}
	questions[95006] = {
--		artifact20 = 0,
--		active_quest = active_quest + 1,
...
--]]
	questions[77000] = {
		...
		alien={"As referenced by the last update of Contace a mere three hours ago, the Diligent was last observed in Bar-zhon space heading towards Spemin territory 12 days ago.  The Excelsior was fired upon in retaliation for earlier attacks 4 days ago and haphazardly retreated somewhat in the direction of Tafal space. This is the extent of my knowledge on the matter.  May we be of any additional service captain?" }
	}
...
function commFxn(type, n, ftest)
	...
	-- All logic below applies to questions (divided up by plot stage to allow us to reuse mission numbers
		...
		-- Universal exchange - Thrynn Battle Machine for energy crystals
		-- This apply to all plot stage, does it not?
		if (n == 510) then
